...
jQuery(function(t){function i(i,e){if(console.log(e),void 0==e){var e=0;/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)||(e=t("nav.navbar").not(".no-fixed-nav nav.navbar").outerHeight(!0))}var a=t(i).offset().top-e;t("html, body").animate({scrollTop:a},500)}function e(){t(window).width()>768&&s(),o(),a()}function a(){/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)?(t(window).scrollTop()>0?t(".scroll-up").css("opacity","1"):t(".scroll-up").css("opacity","0"),t(window).scrollTop()>=t("#who_we_are").outerHeight()?t(".cd-nav-trigger").css("opacity","1"):t(".cd-nav-trigger").css("opacity","0")):(!t(".navbar-stick .navbar").hasClass("navbar-fixed-top")&&d&&(g=t(".navbar").offset().top),t(window).scrollTop()>=g&&d?(t(".navbar-stick .navbar").addClass("navbar-fixed-top"),t(".navbar-filler").height(t(".navbar").outerHeight(!0)),t(".scroll-up").css("opacity","1").addClass("slide-in")):(t(".navbar-stick .navbar").removeClass("navbar-fixed-top"),t(".navbar-filler").height(0),t(".scroll-up").css("opacity","0").removeClass("slide-in")))}function o(){l.each(function(){$this=t(this);var i=t('#cd-vertical-nav a[href="#'+$this.attr("id")+'"]').data("number")-1;$this.offset().top-t(window).height()/2<t(window).scrollTop()&&$this.offset().top+$this.height()-t(window).height()/2>t(window).scrollTop()?(h.eq(i).addClass("active"),v.eq(i).addClass("active")):(h.eq(i).removeClass("active"),v.eq(i).removeClass("active"))});var i=t("#cd-vertical-nav .active").attr("href");console.log(i),"#who_we_are"!==i&&"#contact"!==i&&void 0!==i?r.addClass("black"):r.removeClass("black"),console.log(i)}function s(){t(".vertical-center").each(function(){var i=0,e=t(this).closest(".parent-container"),a=e.prop("nodeName"),o=e.height();"HEADER"==a&&(i=t(".strapline").outerHeight()),t(this).css("top",o/2-t(this).height()/2-i)})}function n(){var i=-1;t(".profiles .reviews").each(function(){t(this).find(".review").each(function(){i=i>t(this).height()?i:t(this).height()}),t(this).find(".review").each(function(){t(this).height(i)})})}function c(){ms_window_height=t(window).height(),ms_window_width=t(window).width(),ms_document_height=t(document).height(),ms_document_width=t(document).width();var i=u;return t("#bootstrap_detector .visible-xs").is(":visible")?u="xs":t("#bootstrap_detector .visible-sm").is(":visible")?u="sm":t("#bootstrap_detector .visible-md").is(":visible")?u="md":t("#bootstrap_detector .visible-lg").is(":visible")&&(u="lg"),i!==u&&(f&&console.log("track_window_size: "+u),t(window).trigger("bootstrapResize")),i!==u}var l=t(".cd-section"),r=t("#cd-vertical-nav"),h=t("#cd-vertical-nav a"),v=t(".navbar-nav li"),d=!0,g=0,f=!0,u="md";c(),e(),t(".navbar-stick .navbar").after("<div class='navbar-filler'></div>"),t.validate(),(new WOW).init(),t(".owl-book").owlCarousel({singleItem:!0,items:1,pagination:!1,autoPlay:3e3}),t(".owl-reviews").owlCarousel({items:3,navigation:!0,autoPlay:5e3,navigationText:["<span class='icon icon-arrow-left'></span>","<span class='icon icon-arrow-right'></span>"]}),t(".get-direction").tooltip({direction:"top"}),t(window).resize(function(){e(),n(),c()}),t(window).on("scroll",function(){e()}),t(document).ready(function(){n()}),t("form").submit(function(){if(!(t(this).find(".has-error").length>0)){event.preventDefault();var i=t(this),e=t(i).attr("action"),a=(t(i).attr("method"),{});t(i).find("[name]").each(function(){a[t(this).attr("name")]=t(this).val()}),t(".notification-box").addClass("active"),t.ajax({type:"POST",url:e,data:a,success:function(i){t(".notification-box span").html(i),setTimeout(function(){t(".notification-box").removeClass("active"),t(".notification-box span").html("Sending...")},4e3)}})}}),t(".touch .cd-nav-trigger").on("click",function(){t(".touch #cd-vertical-nav").toggleClass("open")}),t(".scrollTo, #cd-vertical-nav a, .cd-scroll-down").on("click",function(e){e.preventDefault(),i(t(this.hash))}),t(".green-circle-wrap").click(function(t){t.preventDefault()}),t(".green-circle-wrap").hover(function(){t(this).find(".green-circle").addClass("active")},function(){t(this).find(".green-circle").removeClass("active")}),t(".pathway-button").on("click",function(e){e.preventDefault();var a=t(this).attr("href"),o=t(a).outerHeight(!0),s=t(this).data("bg");t(a).css("display","block"),t(a).toggleClass("active"),t(a).find("h1,p,img").css("visibility","visible"),t(this).toggleClass("active"),t(this).hasClass("active")?t("."+s+", .close").addClass("active"):t("."+s+", .close").removeClass("active"),t(a).hasClass("active")?t(this).closest("section").css("height",o):t(this).closest("section").css("height","auto"),i(a)}),t(".close").on("click",function(i){i.preventDefault(),t(".close, .pathway-button, .info-wrap, .pathways-bg, .toggle").removeClass("active"),t(this).closest("section").css("height","auto")}),t(".toggle").on("click",function(e){e.preventDefault();var a=t(this).attr("href"),o=t(this).data("scroll-to");t(this).text();toggleText=t(this).data("toggle-text"),t(".profiles .toggleable").not(a).removeClass("active"),t(".profiles .toggle").not(t(this)).removeClass("active"),t(this).toggleClass("active"),t(a).length>0&&(t(a).toggleClass("active"),null==o&&(o=a),i(o))}),t(".show-more-profiles").click(function(){var e=t(this).data("toggle-class"),a=t(this).data("scroll-to"),o=t(this).text();toggleText=t(this).data("toggle-text"),t(this).toggleClass("active"),null!=toggleText&&(t(this).text(toggleText),t(this).data("toggle-text",o)),t(this).closest(".reviews").find(e).toggleClass("hidden"),null==a&&(a=e),i(a)})});
