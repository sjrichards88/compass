...
jQuery(function(t){function a(a,e){if(console.log(e),void 0==e){var e=0;/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)||(e=t("nav.navbar").not(".no-fixed-nav nav.navbar").outerHeight(!0))}var i=t(a).offset().top-e;t("html, body").animate({scrollTop:i},500)}function e(){t(window).width()>768&&s(),o(),i()}function i(){/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)?(t(window).scrollTop()>0?t(".scroll-up").css("opacity","1"):t(".scroll-up").css("opacity","0"),t(window).scrollTop()>=t("#who_we_are").outerHeight()?t(".cd-nav-trigger").css("opacity","1"):t(".cd-nav-trigger").css("opacity","0")):(!t(".navbar-stick .navbar").hasClass("navbar-fixed-top")&&v&&(h=t(".navbar").offset().top),t(window).scrollTop()>=h&&v?(t(".navbar-stick .navbar").addClass("navbar-fixed-top"),t(".navbar-filler").height(t(".navbar").outerHeight(!0)),t(".scroll-up").css("opacity","1")):(t(".navbar-stick .navbar").removeClass("navbar-fixed-top"),t(".navbar-filler").height(0),t(".scroll-up").css("opacity","0")))}function o(){n.each(function(){$this=t(this);var a=t('#cd-vertical-nav a[href="#'+$this.attr("id")+'"]').data("number")-1;$this.offset().top-t(window).height()/2<t(window).scrollTop()&&$this.offset().top+$this.height()-t(window).height()/2>t(window).scrollTop()?(l.eq(a).addClass("active"),r.eq(a).addClass("active")):(l.eq(a).removeClass("active"),r.eq(a).removeClass("active"))});var a=t("#cd-vertical-nav .active").attr("href");console.log(a),"#who_we_are"!==a&&"#contact"!==a&&void 0!==a?c.addClass("black"):c.removeClass("black"),console.log(a)}function s(){t(".vertical-center").each(function(){var a=0,e=t(this).closest(".parent-container"),i=e.prop("nodeName"),o=e.height();"HEADER"==i&&(a=t(".strapline").outerHeight()),t(this).css("top",o/2-t(this).height()/2-a)})}var n=t(".cd-section"),c=t("#cd-vertical-nav"),l=t("#cd-vertical-nav a"),r=t(".navbar-nav li"),v=!0,h=0;e(),t(".navbar-stick .navbar").after("<div class='navbar-filler'></div>"),t.validate(),(new WOW).init(),t(".owl-book").owlCarousel({singleItem:!0,items:1,pagination:!1,autoPlay:3e3}),t(".owl-reviews").owlCarousel({items:3,navigation:!0,autoPlay:5e3,navigationText:["<span class='icon icon-arrow-left'></span>","<span class='icon icon-arrow-right'></span>"]}),t(".get-direction").tooltip({direction:"top"}),t(window).resize(function(){e()}),t(window).on("scroll",function(){e()}),t("form").submit(function(){if(!(t(this).find(".has-error").length>0)){event.preventDefault();var a=t(this),e=t(a).attr("action"),i=(t(a).attr("method"),{});t(a).find("[name]").each(function(){i[t(this).attr("name")]=t(this).val()}),t(".notification-box").addClass("active"),t.ajax({type:"POST",url:e,data:i,success:function(a){t(".notification-box span").html(a),setTimeout(function(){t(".notification-box").removeClass("active"),t(".notification-box span").html("Sending...")},4e3)}})}}),t(".touch .cd-nav-trigger").on("click",function(){t(".touch #cd-vertical-nav").toggleClass("open")}),t(".scrollTo, #cd-vertical-nav a, .cd-scroll-down").on("click",function(e){e.preventDefault(),a(t(this.hash))}),t(".green-circle-wrap").click(function(t){t.preventDefault()}),t(".green-circle-wrap").hover(function(){t(this).find(".green-circle").addClass("active")},function(){t(this).find(".green-circle").removeClass("active")}),t(".pathway-button").on("click",function(e){e.preventDefault();var i=t(this).attr("href"),o=t(i).outerHeight(!0),s=t(this).data("bg");t(i).css("display","block"),t(i).toggleClass("active"),t(i).find("h1,p,img").css("visibility","visible"),t(this).toggleClass("active"),t(this).hasClass("active")?t("."+s+", .close").addClass("active"):t("."+s+", .close").removeClass("active"),t(i).hasClass("active")?t(this).closest("section").css("height",o):t(this).closest("section").css("height","auto"),a(i)}),t(".close").on("click",function(a){a.preventDefault(),t(".close, .pathway-button, .info-wrap, .pathways-bg, .toggle").removeClass("active"),t(this).closest("section").css("height","auto")}),t(".toggle").on("click",function(e){e.preventDefault();var i=t(this).attr("href"),o=t(this).data("scroll-to"),s=t(this).text();toggleText=t(this).data("toggle-text"),t(".profiles .toggleable").not(i).removeClass("active"),t(".profiles .toggle").not(t(this)).removeClass("active"),t(this).toggleClass("active"),null!=toggleText&&(t(this).text(toggleText),t(this).data("toggle-text",s)),t(i).length>0&&(t(i).toggleClass("active"),null==o&&(o=i),a(o))})});
