...
jQuery(function(t){function i(i,e){if(console.log(e),void 0==e){var e=0;/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)||(e=t("nav.navbar").not(".no-fixed-nav nav.navbar").outerHeight(!0))}var o=t(i).offset().top-e;t("html, body").animate({scrollTop:o},500)}function e(){t(window).width()>768&&s(),a(),o()}function o(){/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)?(t(window).scrollTop()>0?t(".scroll-up").css("opacity","1"):t(".scroll-up").css("opacity","0"),t(window).scrollTop()>=t("#who_we_are").outerHeight()?t(".cd-nav-trigger").css("opacity","1"):t(".cd-nav-trigger").css("opacity","0")):(!t(".navbar-stick .navbar").hasClass("navbar-fixed-top")&&v&&(d=t(".navbar").offset().top),t(window).scrollTop()>=d&&v?(t(".navbar-stick .navbar").addClass("navbar-fixed-top"),t(".navbar-filler").height(t(".navbar").outerHeight(!0)),t(".scroll-up").css("opacity","1").addClass("slide-in")):(t(".navbar-stick .navbar").removeClass("navbar-fixed-top"),t(".navbar-filler").height(0),t(".scroll-up").css("opacity","0").removeClass("slide-in")))}function a(){var i=t(window).scrollTop();h.each(function(){$this=t(this).find("a");var e=$this.attr("href");t(e).length>0&&t(e).offset().top<=i+200&&(console.log(e),h.each(function(){t(this).removeClass("active")}),$this.parent().addClass("active"))}),r.each(function(){$this=t(this);var i=$this.attr("href");t(i).length>0&&(console.log(i),t(i).offset().top-t(window).height()/2<t(window).scrollTop()&&(r.each(function(){t(this).removeClass("active")}),$this.addClass("active")))});var e=t("#cd-vertical-nav .active").attr("href");console.log(e),"#who_we_are"!==e&&"#contact"!==e&&void 0!==e?l.addClass("black"):l.removeClass("black"),console.log(e)}function s(){t(".vertical-center").each(function(){var i=0,e=t(this).closest(".parent-container"),o=e.prop("nodeName"),a=e.height();"HEADER"==o&&(i=t(".strapline").outerHeight()),t(this).css("top",a/2-t(this).height()/2-i)})}function n(){var i=-1;t(".profiles .reviews").each(function(){t(this).find(".review").each(function(){i=i>t(this).height()?i:t(this).height()}),t(this).find(".review").each(function(){t(this).height(i)})})}function c(){ms_window_height=t(window).height(),ms_window_width=t(window).width(),ms_document_height=t(document).height(),ms_document_width=t(document).width();var i=f;return t("#bootstrap_detector .visible-xs").is(":visible")?f="xs":t("#bootstrap_detector .visible-sm").is(":visible")?f="sm":t("#bootstrap_detector .visible-md").is(":visible")?f="md":t("#bootstrap_detector .visible-lg").is(":visible")&&(f="lg"),i!==f&&(g&&console.log("track_window_size: "+f),t(window).trigger("bootstrapResize")),i!==f}var l=(t(".cd-section"),t("#cd-vertical-nav")),r=t("#cd-vertical-nav a"),h=t(".navbar-nav li"),v=!0,d=0,g=!0,f="md";c(),e(),t(".navbar-stick .navbar").after("<div class='navbar-filler'></div>"),t.validate(),(new WOW).init(),t(".owl-book").owlCarousel({singleItem:!0,items:1,pagination:!1,autoPlay:3e3}),t(".owl-reviews").owlCarousel({items:3,navigation:!0,autoPlay:5e3,navigationText:["<span class='icon icon-arrow-left'></span>","<span class='icon icon-arrow-right'></span>"]}),t(".get-direction").tooltip({direction:"top"}),t(window).resize(function(){e(),n(),c()}),t(window).on("scroll",function(){e()}),t(document).ready(function(){n()}),t("form").submit(function(){if(!(t(this).find(".has-error").length>0)){event.preventDefault();var i=t(this),e=t(i).attr("action"),o=(t(i).attr("method"),{});t(i).find("[name]").each(function(){o[t(this).attr("name")]=t(this).val()}),t(".notification-box").addClass("active"),t.ajax({type:"POST",url:e,data:o,success:function(i){t(".notification-box span").html(i),setTimeout(function(){t(".notification-box").removeClass("active"),t(".notification-box span").html("Sending...")},4e3)}})}}),t(".touch .cd-nav-trigger").on("click",function(){t(".touch #cd-vertical-nav").toggleClass("open")}),t(".scrollTo, #cd-vertical-nav a, .cd-scroll-down").on("click",function(e){e.preventDefault(),i(t(this.hash))}),t(".green-circle-wrap").click(function(t){t.preventDefault()}),t(".green-circle-wrap").hover(function(){t(this).find(".green-circle").addClass("active")},function(){t(this).find(".green-circle").removeClass("active")}),t(".pathway-button").on("click",function(e){e.preventDefault();var o=t(this).attr("href"),a=t(o).outerHeight(!0),s=t(this).data("bg");t(o).css("display","block"),t(o).toggleClass("active"),t(o).find("h1,p,img").css("visibility","visible"),t(this).toggleClass("active"),t(this).hasClass("active")?t("."+s+", .close").addClass("active"):t("."+s+", .close").removeClass("active"),t(o).hasClass("active")?t(this).closest("section").css("height",a):t(this).closest("section").css("height","auto"),i(o)}),t(".close").on("click",function(i){i.preventDefault(),t(".close, .pathway-button, .info-wrap, .pathways-bg, .toggle").removeClass("active"),t(this).closest("section").css("height","auto")}),t(".toggle").on("click",function(e){e.preventDefault();var o=t(this).attr("href"),a=t(this).data("scroll-to");t(this).text();toggleText=t(this).data("toggle-text"),t(".profiles .toggleable").not(o).removeClass("active"),t(".profiles .toggle").not(t(this)).removeClass("active"),t(this).toggleClass("active"),t(o).length>0&&(t(o).toggleClass("active"),null==a&&(a=o),i(a))}),t(".show-more-profiles").click(function(){var e=t(this).data("toggle-class"),o=t(this).data("scroll-to"),a=t(this).text();toggleText=t(this).data("toggle-text"),t(this).toggleClass("active"),null!=toggleText&&(t(this).text(toggleText),t(this).data("toggle-text",a)),t(this).closest(".reviews").find(e).toggleClass("hidden"),null==o&&(o=e),i(o)})});
