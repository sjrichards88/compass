...
jQuery(function(t){function e(e,i){if(void 0==i){var i=0;i=100}var s=t(e).offset().top-i;t("html, body").animate({scrollTop:s},500)}function i(){t(window).width()>768&&a(),o(),s()}function s(){t("body.home").length>0?!t(".navbar-stick .navbar").hasClass("navbar-fixed-top")&&v&&(d=t(".navbar").offset().top):d=0,t(window).scrollTop()>=d&&v?(t(".navbar-stick .navbar").addClass("navbar-fixed-top"),t("body.home").length>0&&t(".navbar-filler").height(u)):t("body.home").length>0&&(t(".navbar-filler").height(0),t(".navbar-stick .navbar").removeClass("navbar-fixed-top")),0==t("body.home").length&&(d+=u),t(window).scrollTop()>=d&&v?t(".scroll-up").css("opacity","1").addClass("slide-in"):t(".scroll-up").css("opacity","0").removeClass("slide-in")}function o(){var e=t(window).scrollTop();h.each(function(){$this=t(this).find("a");var i=$this.attr("href");t(i).length>0&&t(i).offset().top<=e+200&&(console.log(i),h.each(function(){t(this).removeClass("active")}),$this.parent().addClass("active"))}),r.each(function(){$this=t(this);var e=$this.attr("href");t(e).length>0&&(console.log(e),t(e).offset().top-t(window).height()/2<t(window).scrollTop()&&(r.each(function(){t(this).removeClass("active")}),$this.addClass("active")))});var i=t("#cd-vertical-nav .active").attr("href");console.log(i),"#who_we_are"!==i&&"#contact"!==i&&void 0!==i?"#pathways"==i&&t("#pathways .pathways-bg.active").length>0?l.removeClass("black"):l.addClass("black"):l.removeClass("black"),console.log(i)}function a(){t(".vertical-center").each(function(){var e=0,i=t(this).closest(".parent-container"),s=i.prop("nodeName"),o=i.height();"HEADER"==s&&(e=t(".strapline").outerHeight()),t(this).css("top",o/2-t(this).height()/2-e)})}function n(){var e=-1;t(".profiles .reviews").each(function(){t(this).find(".review").each(function(){e=e>t(this).height()?e:t(this).height()}),t(this).find(".review").each(function(){t(this).height(e)})})}function c(){ms_window_height=t(window).height(),ms_window_width=t(window).width(),ms_document_height=t(document).height(),ms_document_width=t(document).width();var e=ms_current_bootstrap_size;return t("#bootstrap_detector .visible-xs").is(":visible")?ms_current_bootstrap_size="xs":t("#bootstrap_detector .visible-sm").is(":visible")?ms_current_bootstrap_size="sm":t("#bootstrap_detector .visible-md").is(":visible")?ms_current_bootstrap_size="md":t("#bootstrap_detector .visible-lg").is(":visible")&&(ms_current_bootstrap_size="lg"),e!==ms_current_bootstrap_size&&(g&&console.log("track_window_size: "+ms_current_bootstrap_size),t(window).trigger("bootstrapResize")),e!==ms_current_bootstrap_size}var l=(t(".cd-section"),t("#cd-vertical-nav")),r=t("#cd-vertical-nav a"),h=t(".navbar-nav li"),v=!0,d=0,g=!0,u=t(".navbar").outerHeight(!0);ms_current_bootstrap_size="md",c(),i(),t(".navbar-stick .navbar").after("<div class='navbar-filler'></div>"),t.validate(),g&&console.log("jQuery Ready, you are viewing template size: "+ms_current_bootstrap_size),(new WOW).init(),t(".owl-book").owlCarousel({singleItem:!0,items:1,pagination:!1,autoPlay:3e3}),t(".owl-reviews").owlCarousel({items:3,itemsDesktop:[1025,3],navigation:!0,autoPlay:5e3,navigationText:["<span class='icon icon-arrow-left'></span>","<span class='icon icon-arrow-right'></span>"]}),t(".get-direction").tooltip({direction:"top"}),t(window).resize(function(){i(),n(),c(),g&&console.log("jQuery Ready, you are viewing template size: "+ms_current_bootstrap_size)}),t(window).on("scroll",function(){i()}),t(document).ready(function(){n()}),t("form").submit(function(e){if(e.preventDefault(),t(this).find(".has-error").length>0)return void t("#contact").addClass("form-error");var i=t(this),s=t(i).attr("action"),o=(t(i).attr("method"),{});t(i).find("[name]").each(function(){o[t(this).attr("name")]=t(this).val()}),t(".notification-box").addClass("active"),t.ajax({type:"POST",url:s,data:o,success:function(e){t(".notification-box span").html(e),setTimeout(function(){t(".notification-box").removeClass("active"),t(".notification-box span").html("Sending...")},4e3)}})}),t(".navbar-nav li a").on("click",function(){t(".navbar-collapse").removeClass("in")}),t(".touch .cd-nav-trigger").on("click",function(){t(".touch #cd-vertical-nav").toggleClass("open")}),t(".scrollTo, #cd-vertical-nav a, .cd-scroll-down").on("click",function(i){i.preventDefault(),e(t(this.hash))}),t(".green-circle-wrap").click(function(t){t.preventDefault()}),Modernizr.touch||t(".green-circle-wrap").hover(function(){t(this).find(".green-circle").addClass("active")},function(){t(this).find(".green-circle").removeClass("active")}),t(".pathway-button").click(function(i){i.preventDefault();var s=t(this).attr("href"),o=t(s).outerHeight(!0),a=t(this).data("bg");t(this).toggleClass("active"),t(".pathway-button").not(this).toggleClass("non-active"),t(s).css("display","block"),t(s).toggleClass("active"),t(s).find("h1,p,img").css("visibility","visible"),t(this).hasClass("active")?t("."+a+", .close").addClass("active"):t("."+a+", .close").removeClass("active"),t(s).hasClass("active")?(t(this).closest("section").css("height",o),l.removeClass("black")):(t(this).closest("section").css("height","auto"),l.addClass("black")),t(s).length>0&&e(s)}),t(".close").on("click",function(e){e.preventDefault(),t(".close, .pathway-button, .info-wrap, .pathways-bg, .toggle").removeClass("active non-active"),t(this).closest("section").is("#pathways")&&l.addClass("black"),t(this).closest("section").css("height","auto")}),t(".toggle").on("click",function(i){i.preventDefault();var s=t(this).attr("href"),o=t(this).data("scroll-to");t(this).text();toggleText=t(this).data("toggle-text"),t(".profiles .toggleable").not(s).removeClass("active"),t(".profiles .toggle").not(t(this)).removeClass("active"),t(this).toggleClass("active"),t(s).length>0&&(t(s).toggleClass("active"),null==o&&(o=s),e(o))}),t(".show-more-profiles").click(function(){var i=t(this).data("toggle-class"),s=t(this).data("scroll-to"),o=t(this).text();toggleText=t(this).data("toggle-text"),t(this).toggleClass("active"),null!=toggleText&&(t(this).text(toggleText),t(this).data("toggle-text",o)),t(this).closest(".reviews").find(i).toggleClass("hidden"),null==s&&(s=i),e(s)})});