...
jQuery(function(t){function e(e,i){if(console.log(i),void 0==i){var i=0;/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)||(i=t("nav.navbar").not(".no-fixed-nav nav.navbar").outerHeight(!0))}var a=t(e).offset().top-i;t("html, body").animate({scrollTop:a},500)}function i(){t(window).width()>768&&o(),s(),a()}function a(){/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)?(t(window).scrollTop()>0?t(".scroll-up").css("opacity","1").addClass("slide-in"):t(".scroll-up").css("opacity","0").removeClass("slide-in"),t(window).scrollTop()>=t("#who_we_are").outerHeight()?t(".cd-nav-trigger").css("opacity","1"):t(".cd-nav-trigger").css("opacity","0")):(!t(".navbar-stick .navbar").hasClass("navbar-fixed-top")&&v&&(d=t(".navbar").offset().top),t(window).scrollTop()>=d&&v?(t(".navbar-stick .navbar").addClass("navbar-fixed-top"),t(".navbar-filler").height(t(".navbar").outerHeight(!0)),t(".scroll-up").css("opacity","1").addClass("slide-in")):(t(".navbar-stick .navbar").removeClass("navbar-fixed-top"),t(".navbar-filler").height(0),t(".scroll-up").css("opacity","0").removeClass("slide-in")))}function s(){var e=t(window).scrollTop();h.each(function(){$this=t(this).find("a");var i=$this.attr("href");t(i).length>0&&t(i).offset().top<=e+200&&(console.log(i),h.each(function(){t(this).removeClass("active")}),$this.parent().addClass("active"))}),r.each(function(){$this=t(this);var e=$this.attr("href");t(e).length>0&&(console.log(e),t(e).offset().top-t(window).height()/2<t(window).scrollTop()&&(r.each(function(){t(this).removeClass("active")}),$this.addClass("active")))});var i=t("#cd-vertical-nav .active").attr("href");console.log(i),"#who_we_are"!==i&&"#contact"!==i&&void 0!==i?"#pathways"==i&&t("#pathways .pathways-bg.active").length>0?c.removeClass("black"):c.addClass("black"):c.removeClass("black"),console.log(i)}function o(){t(".vertical-center").each(function(){var e=0,i=t(this).closest(".parent-container"),a=i.prop("nodeName"),s=i.height();"HEADER"==a&&(e=t(".strapline").outerHeight()),t(this).css("top",s/2-t(this).height()/2-e)})}function n(){var e=-1;t(".profiles .reviews").each(function(){t(this).find(".review").each(function(){e=e>t(this).height()?e:t(this).height()}),t(this).find(".review").each(function(){t(this).height(e)})})}function l(){ms_window_height=t(window).height(),ms_window_width=t(window).width(),ms_document_height=t(document).height(),ms_document_width=t(document).width();var e=f;return t("#bootstrap_detector .visible-xs").is(":visible")?f="xs":t("#bootstrap_detector .visible-sm").is(":visible")?f="sm":t("#bootstrap_detector .visible-md").is(":visible")?f="md":t("#bootstrap_detector .visible-lg").is(":visible")&&(f="lg"),e!==f&&(g&&console.log("track_window_size: "+f),t(window).trigger("bootstrapResize")),e!==f}var c=(t(".cd-section"),t("#cd-vertical-nav")),r=t("#cd-vertical-nav a"),h=t(".navbar-nav li"),v=!0,d=0,g=!0,f="md";l(),i(),t(".navbar-stick .navbar").after("<div class='navbar-filler'></div>"),t.validate(),g&&console.log("jQuery Ready, you are viewing template size: "+f),(new WOW).init(),t(".owl-book").owlCarousel({singleItem:!0,items:1,pagination:!1,autoPlay:3e3}),t(".owl-reviews").owlCarousel({items:3,navigation:!0,autoPlay:5e3,navigationText:["<span class='icon icon-arrow-left'></span>","<span class='icon icon-arrow-right'></span>"]}),t(".get-direction").tooltip({direction:"top"}),t(window).resize(function(){i(),n(),l(),g&&console.log("jQuery Ready, you are viewing template size: "+f)}),t(window).on("scroll",function(){i()}),t(document).ready(function(){n()}),t("form").submit(function(){if(!(t(this).find(".has-error").length>0)){event.preventDefault();var e=t(this),i=t(e).attr("action"),a=(t(e).attr("method"),{});t(e).find("[name]").each(function(){a[t(this).attr("name")]=t(this).val()}),t(".notification-box").addClass("active"),t.ajax({type:"POST",url:i,data:a,success:function(e){t(".notification-box span").html(e),setTimeout(function(){t(".notification-box").removeClass("active"),t(".notification-box span").html("Sending...")},4e3)}})}}),t(".touch .cd-nav-trigger").on("click",function(){t(".touch #cd-vertical-nav").toggleClass("open")}),t(".scrollTo, #cd-vertical-nav a, .cd-scroll-down").on("click",function(i){i.preventDefault(),e(t(this.hash))}),t(".green-circle-wrap").click(function(t){t.preventDefault()}),t(".green-circle-wrap").hover(function(){t(this).find(".green-circle").addClass("active")},function(){t(this).find(".green-circle").removeClass("active")}),t(".pathway-button").on("click",function(i){i.preventDefault();var a=t(this).attr("href"),s=t(a).outerHeight(!0),o=t(this).data("bg");t(a).css("display","block"),t(a).toggleClass("active"),t(a).find("h1,p,img").css("visibility","visible"),t(this).toggleClass("active"),t(this).hasClass("active")?t("."+o+", .close").addClass("active"):t("."+o+", .close").removeClass("active"),t(a).hasClass("active")?(t(this).closest("section").css("height",s),c.removeClass("black")):(t(this).closest("section").css("height","auto"),c.addClass("black")),e(a)}),t(".close").on("click",function(e){e.preventDefault(),t(".close, .pathway-button, .info-wrap, .pathways-bg, .toggle").removeClass("active"),t(this).closest("section").is("#pathways")&&c.addClass("black"),t(this).closest("section").css("height","auto")}),t(".toggle").on("click",function(i){i.preventDefault();var a=t(this).attr("href"),s=t(this).data("scroll-to");t(this).text();toggleText=t(this).data("toggle-text"),t(".profiles .toggleable").not(a).removeClass("active"),t(".profiles .toggle").not(t(this)).removeClass("active"),t(this).toggleClass("active"),t(a).length>0&&(t(a).toggleClass("active"),null==s&&(s=a),e(s))}),t(".show-more-profiles").click(function(){var i=t(this).data("toggle-class"),a=t(this).data("scroll-to"),s=t(this).text();toggleText=t(this).data("toggle-text"),t(this).toggleClass("active"),null!=toggleText&&(t(this).text(toggleText),t(this).data("toggle-text",s)),t(this).closest(".reviews").find(i).toggleClass("hidden"),null==a&&(a=i),e(a)})});
...
jQuery(function(t){"use strict";function o(){t(".form-incomplete").length>0?t("#contact").addClass("form-error"):t("#contact").removeClass("form-error")}t("input[type=text]").blur(function(){""==t.trim(t(this).val())?(t(this).addClass("form-incomplete"),o()):t(this).removeClass("form-incomplete"),o()}),t("textarea").blur(function(){""==t.trim(t(this).val())?t(this).addClass("form-incomplete"):t(this).removeClass("form-incomplete"),o()}),t("form").submit(function(){event.preventDefault();var o=mainForm,e=t(o).attr("action"),i=(t(o).attr("method"),{});t(o).find("[name]").each(function(){i[t(this).attr("name")]=t(this).val()}),t(".notification-box").addClass("active"),t.ajax({type:"POST",url:e,data:i,success:function(o){t(".notification-box span").html(o),setTimeout(function(){t(".notification-box").removeClass("active"),t(".notification-box span").html("Sending...")},4e3)}})}),t(".sample-button-done").click(function(){t("#sample-form").slideUp()})});
